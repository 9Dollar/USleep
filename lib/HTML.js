module.exports = {
    HTML:function(time){
      ...
      console.log(new Date(2007,7,12,hours,min).getTime())
        var one = (new Date(2007,7,12,hours,min).getTime() + 5400000)
        var two = (new Date(2007,7,12,hours,min).getTime() + 10800000)
        var three = (new Date(2007,7,12,hours,min).getTime() + 16200000)
        var four = (new Date(2007,7,12,hours,min).getTime() + 21600000)
        var five = (new Date(2007,7,12,hours,min).getTime() + 27000000)
        var six = (new Date(2007,7,12,hours,min).getTime() + 32400000)
      return `
      <!DOCTYPE html>
<html lang="ko">
<head>
